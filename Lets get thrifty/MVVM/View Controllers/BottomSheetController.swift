...
class BottomSheetControllerWithViewModel<T: BaseViewModel>: BaseViewController<T>, BottomSheet {
    private(set) lazy var handler = BottomSheetControllerHandler(of: self)
    var contentView: UIView {
        fatalError("override the contentView in BottomSheetControllerWithViewModel")
    }
