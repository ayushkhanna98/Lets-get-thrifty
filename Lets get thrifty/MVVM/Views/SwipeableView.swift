...
class SwipeableView: UIView {
    ...
    var internalDelegate: InternalSwipingDelegate?
    ...
    @objc private func panGestureRecognized(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            if let direction = dragDirection, direction == .left || direction == .bottomLeft || direction == .topLeft {
                self.internalDelegate?.didSwipe(swipeDirection: direction, swipePercentage: dragPercentage)
            }
    ...
    private func endedPanAnimation() {
        if let dragDirection = dragDirection, dragDirection != .down, dragDirection != .up, dragPercentage >= SwipeableView.swipePercentageMargin {
